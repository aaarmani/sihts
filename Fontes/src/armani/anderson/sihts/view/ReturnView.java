							...
							.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
								.addGroup(groupLayout.createSequentialGroup()
									.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
										...
										.addComponent(lblDescription, GroupLayout.DEFAULT_SIZE, 107, Short.MAX_VALUE))
									.addGap(18)
									.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
										.addComponent(txtDescription, GroupLayout.PREFERRED_SIZE, 358, Short.MAX_VALUE)
										.addComponent(txtName, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 358, Short.MAX_VALUE)))
								.addGroup(groupLayout.createSequentialGroup()
								...
								.addGroup(groupLayout.createSequentialGroup()
									.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
										...
										.addComponent(lblTimeout, GroupLayout.DEFAULT_SIZE, 108, Short.MAX_VALUE))
									.addGap(18)
